...
CREATE TABLE Authority_Utilisateur (
  ...
  UtilisateurId_a_u)) ENGINE=InnoDB CHARACTER SET UTF8;
...
ALTER TABLE FicheUtilisateur ADD INDEX FKFicheUtili315084 (PaysId_fic), ADD CONSTRAINT FKFicheUtili315084 FOREIGN KEY (PaysId_fic) REFERENCES Pays (Id) ON UPDATE CASCADE ON DELETE SET NULL;
